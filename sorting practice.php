...
//        do
//        {
//            echo "This is do while loop iteration number :".$num."<br>";
//            $num ++;
//        }while($num <= 6)
        
//        function avg_no($num1, $num2)
//        {
//            $avg = ($num1 + $num2)/2;
//            return $avg;
//        }
...
//        echo area(4,5);
        ...
        $num = array(3,5,7,3,2,5,9,8,7,4);
        $rn = array(4,2,6,8,6,66,77,33,11,2,3,9,5,0,66,4,22,778,2);
